...
all: $(ONTOLOGY)-$(ONTOLOGY_DATE).rdf $(ONTOLOGY)-$(ONTOLOGY_DATE)-$(O_LANG).html $(ONTOLOGY).html
...
$(ONTOLOGY)-$(ONTOLOGY_DATE).rdf: $(ONTOLOGY)-$(ONTOLOGY_DATE).unique $(ONTOLOGY)-$(ONTOLOGY_DATE).counts $(ONTOLOGY)-$(ONTOLOGY_DATE).tmp ./scripts/crossRef.py
...
$(ONTOLOGY)-$(ONTOLOGY_DATE)-$(O_LANG).html: $(ONTOLOGY)-$(ONTOLOGY_DATE).rdf $(ONTOLOGY)-template2-$(ONTOLOGY_DATE)-$(O_LANG).html
	./scripts/docgen.py $(ONTOLOGY)-$(ONTOLOGY_DATE).rdf $(ONTOLOGY)-template2-$(ONTOLOGY_DATE)-$(O_LANG).html  $(ONTOLOGY)-$(ONTOLOGY_DATE)-$(O_LANG).html  $(O_LANG)

$(ONTOLOGY)-citations.html: $(ONTOLOGY)-ref.bib
	bibtex2html --use-keys -nodoc -nobibsource -a -dl -unicode --quiet -o - $(ONTOLOGY)-ref.bib  | sed "s/<\/table><hr><p><em>This file was generated by/<\/table>/" | head -n -1 > $(ONTOLOGY)-citations.html
genre-ref.bib:
	curl  "https://api.zotero.org/groups/2089026/items/top?start=0&limit=100&format=bibtex&v=1" | grep -v "abstract = {" | grep -v "keywords = {" > genre-ref.bib
cwrc-ref.bib:
...
testing: all
	...
	cp -f $(ONTOLOGY)-$(ONTOLOGY_DATE).rdf /var/www/html/testing/.
	...
	ln -sf /var/www/html/testing/$(ONTOLOGY)-$(ONTOLOGY_DATE).rdf /var/www/html/testing/$(ONTOLOGY).rdf
