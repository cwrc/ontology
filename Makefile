...
$(ONTOLOGY).html: $(ONTOLOGY)-$(ONTOLOGY_DATE)-en.html
	...
	rm -f $(ONTOLOGY)-$(ONTOLOGY_DATE).counts $(ONTOLOGY)-$(ONTOLOGY_DATE).tmp $(ONTOLOGY)-$(ONTOLOGY_DATE).unique $(ONTOLOGY)-template-$(ONTOLOGY_DATE)-en.html $(ONTOLOGY)-template2-$(ONTOLOGY_DATE).html
